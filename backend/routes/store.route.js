...
router.post("/get_outlet_products", user_verification, get_outlet_products)
router.post("/add_update_outlet_product", user_verification, add_update_outlet_product)

router.post("/get_terminal_products", user_verification, get_terminal_products)
router.post("/add_update_terminal_product", user_verification, add_update_terminal_product)

router.post("/get_dangote_products", user_verification, get_dangote_products)
router.post("/add_update_dangote_product", user_verification, add_update_dangote_product)
...
// outlet collection record
router.post("/get_outletCollection_record", user_verification, get_outletCollection_record)
router.post("/get_selected_outletCollection_record", user_verification, get_selected_outletCollection_record)
router.post("/enter_outletCollection_record", user_verification, enter_outletCollection_record)
router.post("/verify_outletCollection_record", user_verification, verify_outletCollection_record)
router.delete("/delete_outletCollection_record/:id", user_verification, admin_verification, delete_outletCollection_record)
