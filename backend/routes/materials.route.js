...
// GETTERS
router.get("/get_product_materials", get_product_materials);
router.get("/get_raw_materials", get_raw_materials);
router.get(
  "/get_restock_product_materials_record",
  get_restock_product_materials_record,
);
...
router.get("/get_raw_materials_categories", get_raw_materials_categories);

router.post("/get_selected_restock_product_materials_record", get_selected_restock_product_materials_record)
...
router.post("/add_update_raw_materials", add_update_raw_materials);
router.post(
  "/enter_restock_product_materials_record",
  enter_restock_product_materials_record,
);
...
// REMOVALS
router.delete(
  "/delete_product_materials/:id",
  admin_verification,
  delete_product_materials,
);
router.delete(
  "/delete_raw_materials/:id",
  admin_verification,
  delete_raw_materials,
);
router.delete(
  "/delete_restock_product_materials_record/:id",
  admin_verification,
  delete_restock_product_materials_record,
);
router.delete(
  "/delete_restock_raw_materials_record/:id",
  admin_verification,
  delete_restock_raw_materials_record,
);
router.delete(
  "/delete_product_materials_request_record/:id",
  admin_verification,
  delete_product_materials_request_record,
);
router.delete(
...
router.delete(
  "/delete_raw_materials_category/:id",
  admin_verification,
  delete_raw_materials_category,
);
